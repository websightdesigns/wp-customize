...
function wpcustomize_add_pages() {
	...
	add_options_page(__('Customize','wp-customize-menu'), __('Customize','wp-customize-menu'), 'manage_options', 'customize', 'wpcustomize_settings_page');
}
...
function wpcustomize_settings_page() {
	...
	if( isset($_POST[ $hidden_field_name ]) && $_POST[ $hidden_field_name ] == 'Y' ) {
		...
		if( isset( $_POST['wpcustomize_admin_page_title'] ) ) update_option('wpcustomize_admin_page_title', htmlentities(stripslashes($_POST['wpcustomize_admin_page_title'])));
		if( isset( $_POST['wpcustomize_admin_logo_image_url'] ) ) update_option('wpcustomize_admin_logo_image_url', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_image_url'])));
		if( isset( $_POST['wpcustomize_admin_logo_link_url'] ) ) update_option('wpcustomize_admin_logo_link_url', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_link_url'])));
		if( isset( $_POST['wpcustomize_admin_logo_title'] ) ) update_option('wpcustomize_admin_logo_title', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_title'])));
		if( isset( $_POST['wpcustomize_admin_logo_width'] ) ) update_option('wpcustomize_admin_logo_width', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_width'])));
		if( isset( $_POST['wpcustomize_admin_logo_height'] ) ) update_option('wpcustomize_admin_logo_height', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_height'])));
		if( isset( $_POST['wpcustomize_admin_logo_area_width'] ) ) update_option('wpcustomize_admin_logo_area_width', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_area_width'])));
		if( isset( $_POST['wpcustomize_admin_logo_area_height'] ) ) update_option('wpcustomize_admin_logo_area_height', htmlentities(stripslashes($_POST['wpcustomize_admin_logo_area_height'])));
		if( isset( $_POST['wpcustomize_admin_bgcolor'] ) ) update_option('wpcustomize_admin_bgcolor', htmlentities(stripslashes($_POST['wpcustomize_admin_bgcolor'])));
		if( isset( $_POST['wpcustomize_admin_linkcolor'] ) ) update_option('wpcustomize_admin_linkcolor', htmlentities(stripslashes($_POST['wpcustomize_admin_linkcolor'])));
		if( isset( $_POST['wpcustomize_admin_linkhovercolor'] ) ) update_option('wpcustomize_admin_linkhovercolor', htmlentities(stripslashes($_POST['wpcustomize_admin_linkhovercolor'])));
		if( isset( $_POST['wpcustomize_admin_loginstyles'] ) ) update_option('wpcustomize_admin_loginstyles', htmlentities(stripslashes($_POST['wpcustomize_admin_loginstyles'])));
		if( isset( $_POST['wpcustomize_admin_footer_contents'] ) ) update_option('wpcustomize_admin_footer_contents', htmlentities(stripslashes($_POST['wpcustomize_admin_footer_contents'])));
		if( isset( $_POST['wpcustomize_hide_register_forgot_links'] ) ) update_option('wpcustomize_hide_register_forgot_links', htmlentities(stripslashes($wpcustomize_hide_register_forgot_links)));
		if( isset( $_POST['wpcustomize_hide_back_link'] ) ) update_option('wpcustomize_hide_back_link', htmlentities(stripslashes($wpcustomize_hide_back_link)));
		if( isset( $_POST['wpcustomize_show_privacy_policy_link'] ) ) update_option('wpcustomize_show_privacy_policy_link', htmlentities(stripslashes($wpcustomize_show_privacy_policy_link)));
		if( isset( $_POST['wpcustomize_remember_me_by_default'] ) ) update_option('wpcustomize_remember_me_by_default', htmlentities(stripslashes($wpcustomize_remember_me_by_default)));
		if( isset( $_POST['wpcustomize_custom_error_message'] ) ) update_option('wpcustomize_custom_error_message', htmlentities(stripslashes($_POST['wpcustomize_custom_error_message'])));
		if( isset( $_POST['wpcustomize_remove_login_shake'] ) ) update_option('wpcustomize_remove_login_shake', htmlentities(stripslashes($wpcustomize_remove_login_shake)));
		if( isset( $_POST['wpcustomize_admin_login_redirect'] ) ) update_option('wpcustomize_admin_login_redirect', htmlentities(stripslashes($wpcustomize_admin_login_redirect)));
		if( isset( $_POST['wpcustomize_admin_login_redirect_url'] ) ) update_option('wpcustomize_admin_login_redirect_url', htmlentities(stripslashes($_POST['wpcustomize_admin_login_redirect_url'])));
		if( isset( $_POST['wpcustomize_admin_login_background_url'] ) ) update_option('wpcustomize_admin_login_background_url', htmlentities(stripslashes($_POST['wpcustomize_admin_login_background_url'])));
		if( isset( $_POST['wpcustomize_admin_login_background_repeat'] ) ) update_option('wpcustomize_admin_login_background_repeat', htmlentities(stripslashes($_POST['wpcustomize_admin_login_background_repeat'])));
		if( isset( $_POST['wpcustomize_admin_login_background_position'] ) ) update_option('wpcustomize_admin_login_background_position', htmlentities(stripslashes($_POST['wpcustomize_admin_login_background_position'])));
		if( isset( $_POST['wpcustomize_admin_login_background_attachment'] ) ) update_option('wpcustomize_admin_login_background_attachment', htmlentities(stripslashes($_POST['wpcustomize_admin_login_background_attachment'])));
		if( isset( $_POST['wpcustomize_admin_login_background_size'] ) ) update_option('wpcustomize_admin_login_background_size', htmlentities(stripslashes($_POST['wpcustomize_admin_login_background_size'])));
		if( isset( $_POST['wpcustomize_field_name_username'] ) ) update_option('wpcustomize_field_name_username', htmlentities(stripslashes($_POST['wpcustomize_field_name_username'])));
		if( isset( $_POST['wpcustomize_field_name_password'] ) ) update_option('wpcustomize_field_name_password', htmlentities(stripslashes($_POST['wpcustomize_field_name_password'])));
	...
	<form name="wpcustomize_customize" method="post" action="">
		...
		<h2 class="nav-tab-wrapper">
			<a href="?page=customize&tab=display_options" class="nav-tab<?php echo $active_tab == 'display_options' ? ' nav-tab-active' : ''; ?>">Options</a>
			<a href="?page=customize&tab=logo_options" class="nav-tab<?php echo $active_tab == 'logo_options' ? ' nav-tab-active' : ''; ?>">Logo</a>
			<a href="?page=customize&tab=background_options" class="nav-tab<?php echo $active_tab == 'background_options' ? ' nav-tab-active' : ''; ?>">Background</a>
			<a href="?page=customize&tab=custom_css_options" class="nav-tab<?php echo $active_tab == 'custom_css_options' ? ' nav-tab-active' : ''; ?>">Custom CSS</a>
		</h2>
		<?php
			if( $active_tab == 'display_options' ) {
				wpcustomize_display_options();
			} else if( $active_tab == 'logo_options' ) {
				wpcustomize_logo_options();
			} else if( $active_tab == 'background_options' ) {
				wpcustomize_background_options();
			} else if( $active_tab == 'custom_css_options' ) {
				wpcustomize_custom_css_options();
			}
		?>
		<hr />
...
function wpcustomize_display_options() {
	?>
	<table class="form-table">
		<tr valign="top">
		...
		<tr valign="top">
			...
			<td>
			<input type="text" size="42" name="wpcustomize_field_name_username" value="<?php
				echo (isset( $_POST['wpcustomize_field_name_username'] ) && $_POST['wpcustomize_field_name_username'] ? $_POST['wpcustomize_field_name_username'] : html_entity_decode(get_option('wpcustomize_field_name_username', 'user_login')) );
			?>">
			</td>
		</tr>
		<tr valign="top">
			...
			<td>
			<input type="text" size="42" name="wpcustomize_field_name_password" value="<?php
				echo (isset( $_POST['wpcustomize_field_name_password'] ) && $_POST['wpcustomize_field_name_password'] ? $_POST['wpcustomize_field_name_password'] : html_entity_decode(get_option('wpcustomize_field_name_password', 'user_pass')) );
			?>">
			</td>
		</tr>
	</table>
...
function wpcustomize_logo_options() {
	?>
	<table class="form-table">
		<tr valign="top">
...
function wpcustomize_background_options() {
	?>
	<table class="form-table">
		<tr valign="top">
...
function wpcustomize_custom_css_options() {
	?>
	<table class="form-table">
		<tr valign="top">
